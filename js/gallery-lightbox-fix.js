...
function ensureStyle() {
  ...
  style.id = STYLE_ID;
  style.textContent = `
    .photo-viewer-fixed{position:fixed;inset:0;z-index:100000;display:grid;place-items:center;opacity:0;pointer-events:none;background:transparent;transition:opacity .22s ease;overflow:hidden}.photo-viewer-fixed[aria-hidden="false"]{opacity:1;pointer-events:auto}.photo-viewer-fixed__backdrop{position:absolute;inset:0;background:rgba(255,255,255,.965);backdrop-filter:blur(18px) saturate(1.05);-webkit-backdrop-filter:blur(18px) saturate(1.05)}body.dark-mode .photo-viewer-fixed__backdrop,html.theme-dark .photo-viewer-fixed__backdrop{background:rgba(10,12,16,.955)}.photo-viewer-fixed__stage{position:relative;z-index:2;width:min(1180px,90vw);height:min(780px,74vh);overflow:hidden;pointer-events:none;contain:layout style}.photo-viewer-fixed__card{position:absolute;inset:0;margin:0;display:flex;align-items:center;justify-content:center;padding:clamp(14px,1.8vw,26px);opacity:1;transform:translate3d(0,0,0);transition:transform .54s cubic-bezier(.22,1,.36,1),opacity .54s ease;will-change:transform,opacity}.photo-viewer-fixed__card img{display:block;max-width:100%;max-height:100%;width:auto;height:auto;object-fit:contain;border-radius:24px;border:8px solid #fff;background:#fff;box-shadow:0 30px 78px rgba(17,19,24,.18);user-select:none;-webkit-user-drag:none;pointer-events:auto}.photo-viewer-fixed__card.is-entering-right{transform:translate3d(112%,0,0);opacity:.98}.photo-viewer-fixed__card.is-entering-left{transform:translate3d(-112%,0,0);opacity:.98}.photo-viewer-fixed__card.is-current{transform:translate3d(0,0,0);opacity:1}.photo-viewer-fixed__card.is-exiting-left{transform:translate3d(-112%,0,0);opacity:.72}.photo-viewer-fixed__card.is-exiting-right{transform:translate3d(112%,0,0);opacity:.72}.photo-viewer-fixed__caption{position:fixed;z-index:3;left:50%;bottom:clamp(18px,3vh,36px);transform:translateX(-50%);width:min(720px,78vw);margin:0;color:var(--text);font-weight:800;text-align:center;min-height:22px}.photo-viewer-fixed__close,.photo-viewer-fixed__nav{position:fixed;z-index:100002;display:inline-grid;place-items:center;width:46px;height:46px;min-width:46px;padding:0;border-radius:999px;border:1px solid rgba(17,19,24,.12);background:#fff;color:#111318;box-shadow:0 14px 38px rgba(17,19,24,.14);font:inherit;font-size:24px;font-weight:800;line-height:1;cursor:pointer;transform:none;animation:none;transition:background .18s ease,color .18s ease,border-color .18s ease}.photo-viewer-fixed__close{top:88px;right:clamp(18px,4vw,42px);font-size:18px}.photo-viewer-fixed__prev{left:clamp(18px,4vw,42px);top:50%;transform:translateY(-50%)}.photo-viewer-fixed__next{right:clamp(18px,4vw,42px);top:50%;transform:translateY(-50%)}.photo-viewer-fixed__close:hover,.photo-viewer-fixed__nav:hover{background:var(--yellow);color:#111318}.photo-viewer-fixed__prev:hover,.photo-viewer-fixed__next:hover{transform:translateY(-50%)}@media(max-width:760px){.photo-viewer-fixed__stage{width:100vw;height:72vh}.photo-viewer-fixed__card{padding:10px}.photo-viewer-fixed__card img{border-width:4px;border-radius:16px}.photo-viewer-fixed__close{top:82px;right:14px}.photo-viewer-fixed__prev{left:12px}.photo-viewer-fixed__next{right:12px}.photo-viewer-fixed__caption{bottom:14px;font-size:13px}}@media(prefers-reduced-motion:reduce){.photo-viewer-fixed,.photo-viewer-fixed__card,.photo-viewer-fixed__nav,.photo-viewer-fixed__close{transition:none!important;animation:none!important}}
  `;
